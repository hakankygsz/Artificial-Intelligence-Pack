...
_IPAdress = '192.168.1.103'  # Replace with the IP address of your camera
_UserName = 'adminxyz'  # Replace with the username for your camera
_UserPassword = 'adminxyz'  # Replace with the user password for your camera

_FullURL = f'rtsp://{_UserName}:{_UserPassword}@{_IPAdress}/stream2'  # For 1080p change stream 2 to stream1

# Open the STREAM
_capture = cv2.VideoCapture(_FullURL)
